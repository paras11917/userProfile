...
import { faFloppyDisk, faXmark, faSpinner, faUpload, faPenToSquare, faArrowRightFromBracket } from '@fortawesome/free-solid-svg-icons'
          ...
          <div className='absolute top-36 '>
            <div className="ml-8 h-full w-full flex justify-start flex-col">
              ...
              <div className="">
                ...
                {edit ?
                  <input className=' border-b focus:outline-none border-gray-400 bg-gray-100 mt-14 p-2 w-72 ' type='text' onChange={handleChange} placeholder="name" name='name' value={updateData.name} />
                  :
            ...
            <div className=" px-4 py-5 sm:p-6 mt-2 ">
              {edit ?
                <textarea className='rounded border border-gray-400 focus:outline-none bg-gray-100 h-24 p-2 w-80 ml-2 ' type='textarea' placeholder='description' onChange={handleChange} name='dis' value={updateData.dis} />
                :
